...
class HomePage extends Component {
		...
		actors: [
			{
				...
				photo: "C:/Users/kaan/Desktop/metecagan/src/images/mete1.jpeg"
			},
			{
				name: "Ingrid Bergman",
	...
	render() {
		return (
			<div>
				<Image src={require('../../images/mete1yas.jpeg')} />
				<p>Dayıcım iyi ki doğmuşsun sen seni çok seven bizlerle hep mutlu , hep gülerek büyürsün umarım... Nice güzel yıllara :)</p>
			</div>
		);
	}
}
